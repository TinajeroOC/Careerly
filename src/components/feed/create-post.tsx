    ...
    <div className="mb-6 rounded-lg border bg-card p-4 shadow">
      <div className="flex gap-4">
        ...
        <textarea
          ...
          className="min-h-[100px] flex-1 resize-none rounded-md border border-input bg-transparent p-3 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        />
      </div>
      {mediaFiles.length > 0 && (
